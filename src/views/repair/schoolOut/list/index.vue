<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="850px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" v-loading="updateLoading">
        <el-row :gutter="20">
          <el-col :span="12">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="联系人" prop="customerUser">
              <el-input maxlength="10" v-model.number="form.customerUser" placeholder="请输入客户联系人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="接受指派人员" prop="assignmentUserId">
                <el-select v-model="form.assignmentUserId" placeholder="请选择指派人员" clearable style="width: 100%">
                    <el-option
...
<script>
import { listRepair, getRepair, delRepair, addRepair, updateRepair, exportRepair, getCustomer, getCost, getAssign, passAudit, noPassAudit, addOut, getRepairOut, updateRepairOut, exportRepairOne } from "@/api/repair/repair";
      ...
      if(id !=null && id != ''){
        ...
        getRepairOut(id).then(response => {
          this.form = {
            ...
            assignmentUserId: response.data.assignmentUserId,
          };
          this.title = "修改维修列表";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateRepairOut(this.form).then(response => {

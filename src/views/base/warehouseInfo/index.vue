<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['basedata:warehouseInfo:add']"
        >新增</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="warehouseInfoList"  highlight-current-row >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['basedata:warehouseInfo:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['basedata:warehouseInfo:remove']"
          >作废</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listWarehouseInfo, getWarehouseInfo, delWarehouseInfo, addWarehouseInfo, updateWarehouseInfo, exportWarehouseInfo } from "@/api/base/warehouse/warehouseInfo";
